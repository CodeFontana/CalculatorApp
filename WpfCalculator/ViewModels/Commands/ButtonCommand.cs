...
public class ButtonCommand(CalculatorViewModel calculatorViewModel) : ICommand
{
    private readonly CalculatorViewModel _calculatorViewModel = calculatorViewModel;
